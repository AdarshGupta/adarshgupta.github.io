...
function imageRotate(){
    ...
    // Display/Switch to a new image only after it's loaded
    var img = new Image();
    img.onload = function(){
    ...
    img.src = smallThumbnailPath + thumbnailData[randomPic]["fileName"]; //Starts loading the image once the src is set (not displayed yet)
}
